...
func main() {
	...
	var inter customAction.ACTION
	mainaction := customAction.BinaryAction{}
	inter = mainaction
	RunAction(inter)
}

func RunAction(loadAction customAction.ACTION) {

	realconfig := loadAction.InitConfig()
	loadAction.DefineAction(realconfig)
}
*/
